function [u, v, a_t, fs_st, fs, T, phi, M, K, C, time, ug_up] = MDOF_Shear_IMK_seismic_EHHT(h, wi, Pi, k, Xi, ug, dt, do, Vo, Fy, a_s, dcdy, a_c, g, Name, StrengthLimitCheck,CMBt,ij,zeta)
%% 显式HHT法求解函数
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%by郭豪鑫%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%--------------------------------------------------------------------------
...
beta3 = Alpha\(alpha4*beta*dt*dt*K+alpha4*gamma*dt*C);
M1=M*(I-beta3);
M2=M*beta3;
%% 循环计算
for i= 1: size(u,2)-1
